...
function mod_main($title, $description) {
    ...
    mysql_query("update $prefix"._reviews."_main set title='$title', description='$description'");
...
function reviews() {
    ...
    OpenTable();
    echo "<center><font size=\"4\"><b>"._REVADMIN."</b></font></center>";
    CloseTable();
    echo "<br>";
    $resultrm = mysql_query("select title, description from $prefix"._reviews."_main");
    ...
    echo "<br>";
    OpenTable();
    echo "<center><font size=\"3\"><b>"._REVWAITING."</b></font><br>";
    $result = mysql_query("select * from $prefix"._reviews."_add order by id");
    ...
    echo "<a href=\"reviews.php?op=write_review\">"._CLICK2ADDREVIEW."</a></center>";
    CloseTable();
    echo "<br>";
    OpenTable();
    echo "<center><font size=\"3\"><b>"._DELMODREVIEW."</b></font><br><br>"
	.""._MODREVINFO."</center>";
    CloseTable();
    include ("footer.php");
}
...
function add_review($id, $date, $title, $text, $reviewer, $email, $score, $cover, $url, $url_title) {
    ...
    mysql_query("delete from $prefix"._reviews."_add WHERE id = $id");
    Header("Location: admin.php?op=reviews");
}
