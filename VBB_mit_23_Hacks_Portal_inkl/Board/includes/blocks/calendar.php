<?php
$blocks_modules[calendar] = array(
	'title' => 'Calendar',
	'func_display' => 'blocks_calendar_block',
	'text_type' => 'calendar',
...
global $bburl,$DB_site,$bbuserinfo,$calStart,$timeoffset,$block_sidetemplate;
// start calendar //
$year=date("Y");
...
if($row[templates]) {
	eval("\$block_content .= \"".gettemplate('P_calendar')."\";");
}else{
	$block_content ="
