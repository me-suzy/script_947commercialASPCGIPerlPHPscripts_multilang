...
align_text = "Text-Ausrichtung ändern";
code_text = "Monospace Text einfügen";
move_text = "Laufschrift einfügen";
tt_text = "Schreibmaschinenschrift einfügen";
cursor_text = "Cursor verändern";
nimg_text = "Foto-Negativ-Effekt Graustufen";
wt_text = "Wellenartige Störung";
s_text = "Schatten";
mark_text = "Markieren";
glow_text = "Glühender Text";
bt_text = "Blur Text";
d_text = "Text durchstreichen";
sub_text = "Tiefgestellter Text";
sup_text = "Hochgestellter Text";
blink_text = "Blinkender Text >>>NUR Netscape<<<";
ftp_text = "Link zum FTP mit Login,Port,Verzeichniss";
// ERROR MESSAGES
