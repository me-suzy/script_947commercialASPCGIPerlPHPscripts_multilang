...
// activity rate hack end
  doformheader("stats","standard");
  // start activity rate hack
  maketableheader("Activity rate info:");
  echo "<tr class='firstalt'>
		<td><p>0-posters:</p></td>
		<td><p><b>$nonposters</b></p></td>
	</tr>
	<tr class='secondalt'>
		<td><p>Active members:</p></td>
		<td><p><b>$activemembers</b></p></td>
	</tr>
	<tr class='firstalt'>
		<td><p>Activity Rate:</p></td>
		<td><p><b>$activityrate %</b></p></td>
	</tr>";
// end activity rate hack
