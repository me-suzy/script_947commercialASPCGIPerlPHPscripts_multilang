<?php
$forumblocks_modules[search] = array(
	'title' => 'Suchen',
	'func_display' => 'forumblocks_search_block',
	'text_type' => 'search',
...
function forumblocks_search_block($row) {
global $themesidebox,$nuke_title,$block_content;
	$block_title = $row[title];
	global $bburl,$themesidebox,$block_content,$nuke_title;
    ...
    </form><b><a href=\"$bburl/search.php?s=$session[sessionhash]\">Erweiterte Suche</a></smallfont></b>
