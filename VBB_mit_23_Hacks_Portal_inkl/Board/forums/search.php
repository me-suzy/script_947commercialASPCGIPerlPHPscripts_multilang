...
$templatesused = "forumjumpbit,searchintro,redirect_ ,forumdisplay_gotonew,error_searchnoresults,error_searchinvalidterm,searchresultbit,searchresultbit_threadonly,searchresults,searchresults_threadonly";
...
//    	show_nopermission();
  ...
  // set defaults
  if (!isset($perpage) or $perpage==0 or $perpage=="") {
  ...
  if (!isset($pagenumber) or $pagenumber==0 or $pagenumber=="") {
    $pagenumber=1;
  }
...
// ##### [HIDE] [/HIDE] HACK Start #####
        ...
        if ($i >=1){
          $searchresult[pagetext] = str_replace($searchresult[pagetext], "[Der Beitrag enthält versteckten Text!]",  $searchresult[pagetext]);
        } 
        // ##### [HIDE] [/HIDE] HACK End #####
