...
*/
	...
	/* get active auctions for this user */
			$result = mysql_query ( "SELECT * FROM PHPAUCTION_auctions WHERE user='".addslashes($user_id)."' AND closed='1' ORDER BY starts DESC" );
	...
	/* get this user's nick */
			...
			include "header.php";
			include "templates/template_users_closed_auctions_header_php.html";
			include "templates/template_auctions_closed.html";
			include "footer.php";
			exit;
?>
