...
$GLOBALS['strViewsPurchased'] = "Bannervisninger kjøpt";
$GLOBALS['strClicksPurchased'] = "Bannerklikk kjøpt";
$GLOBALS['strDaysPurchased'] = "Bannerdager kjøpt";
...
$GLOBALS['strModifyBannerAcl'] = "Endre banner ACL";
...
$GLOBALS['strMailHeader'] = "Kjære {contact},\n";
...
$GLOBALS['strAllowClientModifyInfo'] = "Tillat denne brukeren å endre sin egen klientinformasjon";
$GLOBALS['strAllowClientModifyBanner'] = "Tillat denne brukeren å endre sine egne bannere";
$GLOBALS['strAllowClientAddBanner'] = "Tillat denne brukeren å legge til egne bannere";
$GLOBALS['strLanguage'] = "Språk";
$GLOBALS['strDefault'] = "Standard";
$GLOBALS['strErrorViews'] = "Du må velge antall visninger, eller velge ubegrenset !";
$GLOBALS['strErrorNegViews'] = "Negativt antall visninger er ikke tillatt";
$GLOBALS['strErrorClicks'] =  "Du må velge antall klikk, eller velge ubegrenset !";
$GLOBALS['strErrorNegClicks'] = "Negativt antall klikk er ikke tillatt";
$GLOBALS['strErrorDays'] = "Du må velge antall dager, eller velge ubegrenset !";
...
$GLOBALS['strAllowClientDisableBanner'] = "Tillat denne brukeren å deaktivere sine egne bannere";
$GLOBALS['strAllowClientActivateBanner'] = "Tillat denne brukeren å aktivere sine egne bannere";
...
$GLOBALS['strAutoChangeHTML']			= "Endre HTML for å logge klikk";
...
$GLOBALS['strOnlyDisplayWhen']			= "Vis dette banneret bare når:";
...
$GLOBALS['strRawQueryString']			= "Ren spørrestreng";

$GLOBALS['strBannerWeight']				= "Banner vekt";
$GLOBALS['strCampaignWeight']			= "Kampanje vekt";

$GLOBALS['strZoneCacheOn']				= "Sone caching/bufring er slått på";
$GLOBALS['strZoneCacheOff']				= "Sone caching/bufring er slått av";
$GLOBALS['strCachedZones']				= "Cachede/Bufrede soner";
$GLOBALS['strSizeOfCache']				= "Størrelse på cache/buffer";
...
$GLOBALS['strExpired']					= "Utløpt";

$GLOBALS['strModifyBannerAcl'] 			= "Display limitations";
$GLOBALS['strACL'] 						= "Limit";
$GLOBALS['strNoMoveUp'] 				= "Kan ikke flyttet til første rad";
